...
bot = telebot.TeleBot('7934288137:AAHvU0HjijuUSHw_TK7qqKCB6aXDeWvJEVU')
...
🚀 𝐴𝐶𝐶𝐸𝑆𝑆 𝐻𝐸𝑅𝐸 :- @NEONxCHEATZ2
🚀 𝐽𝑂𝐼𝑁 𝐹𝐴𝑀𝐼𝐿𝐼𝑌:- @NEONxCHEATZ2
'''
...
def welcome_start(message):
    ...
    response = f'''𝑊𝐸𝐿𝐶𝑂𝑀𝐸 𝑇𝑂 𝐷𝐷𝑂𝑆 𝑆𝐸𝑅𝑉𝐸𝑅 𝑇𝐻𝐼𝑆 𝐹𝐼𝐿𝐸 𝑃𝑅𝑂𝑉𝐼𝐷𝐸 𝐵𝑌 @NEONxCHEATZ2
 𝑁𝐸𝐸𝐷 𝑃𝑅𝑂𝑂𝐹 𝐴𝑁𝐷 𝐷𝐷𝑂𝑆 𝐹𝐼𝐿𝐸 𝐽𝑂𝐼𝑁 𝐻𝐸𝑅𝐸
 𝐽𝑂𝐼𝑁 𝑇𝑂 𝐹𝐴𝑀𝐼𝐿𝐼𝑌 :- @NEONxCHEATZ2'''
    bot.reply_to(message, response)
...
𝐵𝐺𝑀𝐼 𝐷𝐷𝑂𝑆 𝑃𝐿𝐴𝑁 𝑁𝐸𝐸𝐷 𝐹𝑅𝐸𝐸 𝑇𝑂 𝐽𝑂𝐼𝑁 @NEONxCHEATZ2 𝐹𝑂𝑅 𝐹𝑅𝐸𝐸 𝐵𝑂𝑇𝑆 𝐴𝑁𝐷 𝐹𝐼𝐿𝐸 
'''
    bot.reply_to(message, response)
